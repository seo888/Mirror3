festival()
function festival(){if(!isFrontEnv()){return}
var url="/commentViewCount/ajax/holidayPendant";var res='';$.ajax({type:"GET",url:url,data:{},async:false,success:function(data){console.log(data);res=JSON.parse(data.holidayPendant)}});if(res&&res.isOpen==true){require(['/public/cjgj/restival.js'],function(c){var nTime=new Date().getTime();var qxurl=location.href.replace(location.origin,'')
res.nowTime=nTime
if(res.location==1&&qxurl!='/'){return}
